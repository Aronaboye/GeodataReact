    ...
    return (
        <div
            ...
            <div
                ...
                <h2 className="text-2xl mb-4">Voici les informations sur {country.name.common}</h2>
                <p className="text-lg mb-2">
                    <span className="font-semibold">La Langue</span>
                    : {Object.entries(country.languages).map(lang => lang[1] + " ")}
                </p>
                <p className="text-lg mb-2">
                    <span className="font-semibold">La Capitale</span> : {country.capital[0]}
                </p>
                <p className="text-lg mb-2">
                    <span className="font-semibold">La Population</span> : {country.population}
                </p>
            </div>
        </div>
    )
